...
class Attacker(object):
    ...
    def attack(self):
        ...
        faces = self._database.generate_faces(self._attack_size)
        
        # check if there were any matches
        matched_faces = self._database.check_for_matches(faces)
    
        # document if there were matches
        plot_points(range(self._attack_size), matched_faces, x_name="Attack number", y_name="Hits")
